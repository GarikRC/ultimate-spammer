...
def WhatsAppSpammer(target, msg, quantity, browserSession=None):
    ...
    except (TimeoutException, KeyboardInterrupt, NoSuchElementException, IndexError) as error:
        browser.close()
        raise error
...
def FacebookSpammer (email, password, target, msg, quantity, browserSession=None):
    ...
    except (TimeoutException, KeyboardInterrupt, NoSuchElementException) as error:
        browser.close()
        raise error
